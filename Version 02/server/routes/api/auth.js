...
const getEmailTemplate = (type, data = {}) => {
  const baseUrl = process.env.SERVER_URL || 'https://ba-grocery.onrender.com';
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <div style="text-align: center; margin: 30px 0;">
              <a href="${baseUrl}/api/auth/reset-password/${data.token}" 
            ...
            <p style="word-break: break-all; background-color: #f8f9fa; padding: 10px; border-radius: 3px;">
              ${baseUrl}/api/auth/reset-password/${data.token}
            </p>
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <div style="text-align: center; margin-top: 30px;">
              <a href="${process.env.CLIENT_URL || 'https://ba-admin.onrender.com'}/login" 
    ...
    <body>
        <div class="container">
            ...
            <div style="text-align: center;">
                <p>Your password has been successfully reset!</p>
                <a href="${process.env.CLIENT_URL || 'https://ba-admin.onrender.com'}/login" class="btn" style="display: inline-block; margin-top: 20px; text-decoration: none;">
                    Continue to Login
                </a>
            </div>
            `}
            ...
            <div class="back-link">
                <a href="${process.env.CLIENT_URL || 'https://ba-admin.onrender.com'}/login">← Back to Login</a>
            </div>
        </div>
...
// NEW: Handle reset password form submission (POST request)
